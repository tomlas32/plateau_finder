...
from temp_analysis_utils import summerise_ch_stats, find_distinct_plateaus
        ...
        try:
            ...
            if find_plateaus:
                ...
                for i in range(len(plateau_list)):
                    ...
                    df_dict[f"Plataeu_{i+1}"] = summerise_ch_stats(plateau_list[i], channels, f"Plataeu_{i+1}")
            else:
                ...
                for j in range(len(start_index)):
                    ...
                    # calculate min, max and mean of each temperature plateau and pass it into a dictionary
                    df_dict[f"Plataeu_{j+1}"] = summerise_ch_stats(df, channels, f"Plataeu_{j+1}")
